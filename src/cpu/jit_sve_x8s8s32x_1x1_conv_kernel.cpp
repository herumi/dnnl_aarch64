...
#include "jit_sve_x8s8s32x_1x1_conv_kernel.hpp"
...
void jit_sve_x8s8s32x_1x1_conv_kernel::bcast_loop(int load_loop_blk)
{
...
void jit_sve_x8s8s32x_1x1_conv_kernel::cvt2ps(data_type_t type_in,
         ...
         int ur, int substep, bool wraparound)
{
    ...
    auto bcast_ptr = [=](Zmm bcast_reg, int i_reduce, int i_ur, bool bcast) {
        assert(i_ur < jcp.ur);
        ...
        auto raw_offt = jcp.typesize_in * _offt;
...
void jit_sve_x8s8s32x_1x1_conv_kernel::generate()
{
    preamble();
...
bool jit_sve_x8s8s32x_1x1_conv_kernel::post_ops_ok(
...
status_t jit_sve_x8s8s32x_1x1_conv_kernel::init_conf(
...
void jit_sve_x8s8s32x_1x1_conv_kernel::init_scratchpad(
